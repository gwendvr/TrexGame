...
namespace TrexRunner
{
    ...
    public class TRexRunnerGame : Game
    {
        ...
        private const string ASSET_NAME_SPRITE = "TrexSprite";
        ...
        private GraphicsDeviceManager _graphics; //Used to initialize and control the graphics device
        private SpriteBatch _spriteBatch; //Helper class

        //Add 3 sound effect of the game
        private SoundEffect _sfxHit;
        private SoundEffect _sfxButtonPress;
        private SoundEffect _sfxScoreReached;

        //Add graphics of the game
        ...
        protected override void LoadContent()
        {
            ...
            _spriteSheetTexture = Content.Load<Texture2D>(ASSET_NAME_SPRITE);
